      ...
      <div class="sidenav-toggler sidenav-toggler-inner d-xl-block d-none" :class="isRTL ? 'me-3' : ''">
        <a href="#" class="p-0 nav-link text-body" @click.prevent="navbarMinimize">
          <div class="sidenav-toggler-inner">
            <i
class="sidenav-toggler-line" :class="
...
class="sidenav-toggler-line" :class="
      ...
      <div
id="navbar" class="mt-2 collapse navbar-collapse mt-sm-0 me-md-0 me-sm-4"
        ...
        <ul class="navbar-nav justify-content-end">
          ...
          <li class="px-3 nav-item dropdown d-flex align-items-center" :class="isRTL ? 'ps-2' : 'pe-2'">
            <a
id="dropdownMenuButton" href="#" :class="`p-0 nav-link ${isNavFixed && !darkMode ? ' opacity-8 text-dark' : 'text-white'
            } ${showMenu ? 'show' : ''}`" data-bs-toggle="dropdown" aria-expanded="false"
              @click="showMenu = !showMenu">
              <i class="cursor-pointer fa fa-bell"></i>
            </a>
            <ul
class="px-2 py-3 dropdown-menu dropdown-menu-end me-sm-n4" :class="showMenu ? 'show' : ''"
                ...
                <a class="dropdown-item border-radius-md" href="javascript:;">
                  <div class="py-1 d-flex">
                    <div class="my-auto avatar avatar-sm bg-gradient-secondary me-3">
                      <svg
width="12px" height="12px" viewBox="0 0 43 36" version="1.1"
...
class="color-background"
          ...
          <li class="nav-item d-flex align-items-center">
            <router-link
              :to="{ name: 'Settings' }" class="px-0 nav-link font-weight-bold" :class="
          ...
          <li class="nav-item d-xl-none ps-3 d-flex align-items-center">
            <a id="iconNavbarSidenav" href="#" class="p-0 nav-link text-white" @click.prevent="navbarMinimize">
              <div class="sidenav-toggler-inner">
                <i
:class="`sidenav-toggler-line ${isNavFixed && !darkMode ? ' opacity-8 bg-dark' : 'bg-white'
                }`"></i>
                <i
:class="`sidenav-toggler-line ${isNavFixed && !darkMode ? ' opacity-8 bg-dark' : 'bg-white'
                }`"></i>
