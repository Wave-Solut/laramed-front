...
title="Sales" count="$230,220" :percentage="{
                color: 'success',
                value: '+55%',
    ...
    },
    {
        ...
        route: '/',
            ...
            <default-statistics-card
title="Customers" count="3.200" :percentage="{
                color: 'success',
                value: '+12%',
                label: 'since last month',
            }" menu="9 June - 12 June" :dropdown="[
    {
        label: 'Last 7 days',
        route: 'javascript:;',
    },
    ...
    },
    {
        ...
        route: 'javascript:;',
            ...
            <default-statistics-card
title="Avg. Revenue" count="$1.200" :percentage="{
                color: 'secondary',
                value: '+$213',
                label: 'since last month',
            }" menu="6 August - 9 August" :dropdown="[
    {
        label: 'Last 7 days',
        route: 'javascript:;',
    },
                ...
                <div class="card">
                    ...
                    <div class="p-3 card-body">
                        <ul class="list-group list-group-flush list my--3">
                            <li
v-for="({ flag, country, sale, bounce }, index) in sales" :key="index"
        ...
        <div class="mt-4 row">
            <div class="col-12">
                <orders-list-card
title="Top Selling Products" :headers="['Product', 'Value', 'Ads Spent', 'Refunds']"
                    :lists="products" />
            </div>
        </div>
    </div>
