        ...
        <div class="card">
          ...
          <div class="px-0 pb-0 card-body">
            <div class="table-responsive">
              <table id="countries-list" class="table table-flush">
                  ...
                  <tr v-for="country in countries" :key="country.id">
                    <td>
                      <div class="d-flex">
                        ...
                        <p class="my-auto ms-3 text-xs">{{ country.id }}</p>
                      </div>
                    </td>
                    <td class="text-xs">{{ country.name }}</td>
                    <td class="text-xs">
                      {{ country.code }}
                    </td>
...
export default {
  ...
  mounted() {
    if (document.getElementById("countries-list")) {
      const dataTableSearch = new DataTable("#countries-list", {
        searchable: true,
        fixedHeight: false,
        perPage: 7,
      });
  ...
  methods: {
    async deleteCountry(countryId) {
      ...
      await this.$store.dispatch("deleteCountry", countryId);
    },
  },
  async created() {
