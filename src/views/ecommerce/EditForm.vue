    ...
    <div class="py-4 container-fluid" >
      <div class="row">
        <div class="col-lg-5 mx-3">
          <h4 class="text-white">{{vform.name}}  | id : {{form.id}} </h4>
  ...
  export default {
    ...
    methods: {
        ...
        deleteForm(){
            ...
            this.$store.dispatch( 'deleteForm', this.$route.params.id);
        },
        ...
        saveForm(){
            ...
            axios.put('/form/'+this.$route.params.id, this.vform ).then(({data}) => {
                ...
                this.vform.name = this.$store.state.form.name;
             });
        },
    },
    created() {
        console.log('The id is: ' + this.$route.params.id);
        this.$store.dispatch( 'loadForm', this.$route.params.id);
        this.vform.name = this.$store.state.form.name;
      },
      computed: {
